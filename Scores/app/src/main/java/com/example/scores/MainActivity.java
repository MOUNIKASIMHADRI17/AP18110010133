...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            String s=savedInstanceState.getString("Mounika");
            String u=savedInstanceState.getString("Simhadri");
            t1.setText(s);
            t2.setText(u);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putString("Mounika",t1.getText().toString());
        outState.putString("Simhadri",t2.getText().toString());
    }
}